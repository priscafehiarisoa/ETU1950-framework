tomcat_lib='/Applications/apache-tomcat-10.0.27/lib*'
tomcat_webapps='/Applications/apache-tomcat-10.0.27/webapps'
project_path='test-framework2/src/main'
framework_path='framework_2/src/main/java'
...
compile $framework_path framework-temp "$tomcat_lib"
